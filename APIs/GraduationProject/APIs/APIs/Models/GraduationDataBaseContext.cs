...
public partial class GraduationDataBaseContext : IdentityDbContext<ApplicationUser,ApplicationRole,Guid>
{
    ...
    {
        optionsBuilder.UseSqlServer("Server=172.17.0.2,1433;Database=GraduationDataBase;User Id=SA;Password=Mohsen123%^&;MultipleActiveResultSets=true;TrustServerCertificate=Yes");
    }
    #endregion
