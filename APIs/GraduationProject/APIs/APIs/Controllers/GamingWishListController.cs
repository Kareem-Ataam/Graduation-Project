...
namespace APIs.Controllers
{
    ...
    public class GamingWishListController : ControllerBase
    {
        ...
        public async Task<IActionResult> DeleteGamingWishlistByProductID(int productId)
        {
            var GamingWishlist = await _context.GamingWishlists.FirstOrDefaultAsync(bw => bw.ProductId == productId);
