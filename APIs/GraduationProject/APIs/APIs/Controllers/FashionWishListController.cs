...
namespace APIs.Controllers
{
    ...
    public class FashionWishListController : ControllerBase
    {
        ...
        public async Task<IActionResult> DeleteFashionWishlistByProductID(int productId)
        {
            var FashionWishlist = await _context.FashionWishlists.FirstOrDefaultAsync(bw => bw.ProductId == productId);
