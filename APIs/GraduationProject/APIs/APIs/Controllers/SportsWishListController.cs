...
namespace APIs.Controllers
{
    ...
    public class SportsWishListController : ControllerBase
    {
        ...
        public async Task<IActionResult> DeleteSportsWishlistByProductID(int productId)
        {
            var SportsWishlist = await _context.SportsWishlists.FirstOrDefaultAsync(bw => bw.ProductId == productId);
